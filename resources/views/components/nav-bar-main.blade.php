<nav class="navbar navbar-expand-md shadow-sm pb-3">
    <div class="container-fluid">
        <a class="navbar-brand web-logo" href="#"><img src="{{ asset('webassets/images/QuizTech.png') }}"
                alt="Logo" class="img-fluid" id="logo"></a>
